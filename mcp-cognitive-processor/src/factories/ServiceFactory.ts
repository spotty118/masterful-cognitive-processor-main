...
import { MCPConfig, ThinkingModel, PipelineStep } from '../models/types.js';
...
import { GeminiServiceAdapter } from '../services/GeminiServiceAdapter.js';
...
export class ServiceFactory {
  private static cacheService: ICacheService;
  private static memoryService: IMemoryService;
  private static thinkingService: IThinkingService;
  private static tokenOptimizer: TokenOptimizerImpl;
  private static geminiService: IAIService;
  private static claudeService: IAIService;
  private static defaultService: IAIService;
  private static deepSeekService: IAIService;
  private static googleFlashService: IAIService;
  private static o1MiniService: IAIService;
  private static processingPipelineOrchestrator: ProcessingPipelineOrchestrator;
  ...
  static getThinkingService(config: MCPConfig): IThinkingService {
    if (!this.thinkingService) {
      ...
      this.thinkingService = new ThinkingServiceImpl(
        this,
        tokenOptimizer,
        config,
        geminiService
