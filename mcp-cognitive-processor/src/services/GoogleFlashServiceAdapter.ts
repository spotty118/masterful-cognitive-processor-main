...
export class GoogleFlashServiceAdapter implements IAIService {
    private apiKey: string;
    private model: string = 'google/gemini-2.0-flash-exp-02-05:free'; // OpenRouter model ID for Google Flash
