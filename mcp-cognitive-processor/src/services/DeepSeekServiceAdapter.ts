...
export class DeepSeekServiceAdapter implements IAIService {
    // A map to store instances with unique IDs
    private static instances: Map<string, DeepSeekServiceAdapter> = new Map();
    private openaiClient: OpenAI;
    private apiKey: string;
    private model: string;
    private instanceId: string;

    constructor(apiKey: string, model: string = 'deepseek-ai/deepseek-chat-8b') {
    ...
    public static getInstance(apiKey: string, model?: string): DeepSeekServiceAdapter {
