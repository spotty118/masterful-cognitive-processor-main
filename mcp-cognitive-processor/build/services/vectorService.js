 ...
 */
export const storeVector = async (content, type, source) => {
 ...
 */
export const performVectorMaintenance = async () => {
    try {
        saveVectorsToDisk();
