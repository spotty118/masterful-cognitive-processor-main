 ...
 */
export function optimizeTokenUsage(text, context = {}) {
    return tokenOptimizer.optimizeTokenUsage(text, context);
}
/**
 * Estimate token count for text
 */
export function estimateTokenCount(text, model) {
    return tokenOptimizer.estimateTokenCount(text, model);
}
/**
 * Update token metrics
 */
export function updateTokenMetrics(problemId, estimatedTokens, actualTokens, model) {
